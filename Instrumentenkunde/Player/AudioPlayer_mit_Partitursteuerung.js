...
AudioObject.prototype.addEventListeners = function () {
    ...
    document.addEventListener('click', AudioObject.prototype.clickTest, false);
};
...
AudioObject.prototype.play = function () {
 ...
 /* AudioObject.prototype.clickTest = function () {
    alert(parseFloat(event.target.id.slice(-1)))
    if (event.target == this.playbutton.id) {
        alert("richtig!");
    } else {
              alert("daneben.");
              }
