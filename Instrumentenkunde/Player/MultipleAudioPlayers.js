...
var files = ["El_Choclo_di_Sarli.wav", // 0
			"Kratzer_-_Verano_porteno_Anfang.wav", // 1
			];
...
function createAudioElements() {
	for (f in files) {
		var audioString = "<audio id=\"audio-" + f + "\" class=\"audio\" preload=\"true\"><source src=\"../Instrumente/Saiteninstr./Streichinstr./Violine_Medien/Violine_Tonbeispiele/Violine_Spieltechniken/" + files[f] + "\"></audio>";
